...
pub struct AppAddresses {
    ...
    pub current_zone_address: usize,
    pub current_room_address: usize,
    pub current_screen_address: usize,
...
const ADDRESS_LOOKUP: phf::Map<&'static str, AppAddresses> = phf_map! {
    "1.0.0.1" => AppAddresses {
        ...
        current_zone_address: 0xdb4bb7,
        current_room_address: 0xdb4bb3,
        current_screen_address: 0xdb4bb6,
    ...
    "1.6.6.2" => AppAddresses {
        ...
        current_zone_address: 0xdc0ee6,
        current_room_address: 0xdc0ebe,
        current_screen_address: 0xdc0ebf,
        ...
        option_pos_cy_address: 0x00dc3470,
        option_pos_cx_address: 0x0dc3454,
