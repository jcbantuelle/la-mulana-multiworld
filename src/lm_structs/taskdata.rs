...
pub struct TaskData {
    ...
    pub unknown1: u8, // 0x263 (611) - 1 byte
    pub unknown2: u8, // 0x264 (612) - 1 byte
    pub sort_z: i32, // 0x268 (616) - 4 bytes
    pub st_flag_num: u8, // 0x269 (617) - 1 byte
    pub unknown3: u8, // 0x26A (618) - 1 byte
    pub unknown4: u8, // 0x26B (619) - 1 byte
    pub unknown5: u8, // 0x26C (620) - 1 byte
    ...
    pub unknown6: u8, // 0x2DE (734) - 1 byte
    pub unknown7: u8, // 0x2DF (735) - 1 byte
    ...
    pub unknown8: u8, // 0x2FA (762) - 1 byte
    pub unknown9: u8, // 0x2FB (763) - 1 byte
    pub cash_no: i32, // 0x2FC (764) - 4 bytes
    pub end_flag_num: u8, // 0x300 (768) - 1 byte
    pub unknown10: u8, // 0x301 (769) - 1 byte
    pub unknown11: u8, // 0x302 (770) - 1 byte
    pub unknown12: u8, // 0x303 (771) - 1 byte
