...
lazy_static! {
    pub static ref ARCHIPELAGO_ITEM_LOOKUP: HashMap<u64, Item> = HashMap::from([
        ...
        (2359021, Item{item_id: 19, item_name: "Ankh Jewel (Amphisbaena)", flag: 0x8e, value: 1}),
        (2359022, Item{item_id: 19, item_name: "Ankh Jewel (Sakit)", flag: 0x8f, value: 1}),
        (2359023, Item{item_id: 19, item_name: "Ankh Jewel (Elmac)", flag: 0x90, value: 1}),
        (2359024, Item{item_id: 19, item_name: "Ankh Jewel (Bahamut)", flag: 0x91, value: 1}),
        (2359025, Item{item_id: 19, item_name: "Ankh Jewel (Viy)", flag: 0x92, value: 1}),
        (2359026, Item{item_id: 19, item_name: "Ankh Jewel (Palenque)", flag: 0x93, value: 1}),
        (2359027, Item{item_id: 19, item_name: "Ankh Jewel (Baphomet)", flag: 0x94, value: 1}),
        (2359028, Item{item_id: 19, item_name: "Ankh Jewel (Tiamat)", flag: 0x95, value: 1}),
        (2359029, Item{item_id: 19, item_name: "Ankh Jewel (Mother)", flag: 0x853, value: 1}),
        ...
        (2359139, Item{item_id: 69, item_name: "Sacred Orb (Surface)", flag: 0xc8, value: 1}),
        (2359140, Item{item_id: 69, item_name: "Sacred Orb (Gate of Guidance)", flag: 0xc7, value: 1}),
        (2359141, Item{item_id: 69, item_name: "Sacred Orb (Mausoleum of the Giants)", flag: 0xc9, value: 1}),
        (2359142, Item{item_id: 69, item_name: "Sacred Orb (Temple of the Sun)", flag: 0xca, value: 1}),
        (2359143, Item{item_id: 69, item_name: "Sacred Orb (Spring in the Sky)", flag: 0xcb, value: 1}),
        (2359144, Item{item_id: 69, item_name: "Sacred Orb (Tower of Ruin)", flag: 0xcf, value: 1}),
        (2359145, Item{item_id: 69, item_name: "Sacred Orb (Chamber of Extinction)", flag: 0xcc, value: 1}),
        (2359146, Item{item_id: 69, item_name: "Sacred Orb (Twin Labyrinths)", flag: 0xcd, value: 1}),
        (2359147, Item{item_id: 69, item_name: "Sacred Orb (Dimensional Corridor)", flag: 0xd0, value: 1}),
        (2359148, Item{item_id: 69, item_name: "Sacred Orb (Shrine of the Mother)", flag: 0xce, value: 1}),
        ...
        (2359086, Item{item_id: 85, item_name: "reader.exe", flag: 0xe2, value: 2}),
        (2359087, Item{item_id: 86, item_name: "xmailer.exe", flag: 0xe3, value: 1}),
        (2359088, Item{item_id: 87, item_name: "yagomap.exe", flag: 0xe4, value: 2}),
        (2359089, Item{item_id: 88, item_name: "yagostr.exe", flag: 0xe5, value: 2}),
        (2359090, Item{item_id: 89, item_name: "bunemon.exe", flag: 0xe6, value: 2}),
        (2359091, Item{item_id: 90, item_name: "bunplus.com", flag: 0xe7, value: 1}),
        (2359092, Item{item_id: 91, item_name: "torude.exe", flag: 0xe8, value: 2}),
        (2359093, Item{item_id: 92, item_name: "guild.exe", flag: 0xe9, value: 2}),
        (2359094, Item{item_id: 93, item_name: "mantra.exe", flag: 0xea, value: 2}),
        (2359095, Item{item_id: 94, item_name: "emusic.exe", flag: 0xeb, value: 1}),
        (2359096, Item{item_id: 95, item_name: "beolamu.exe", flag: 0xec, value: 1}),
        (2359097, Item{item_id: 96, item_name: "deathv.exe", flag: 0x14f, value: 2}),
        (2359098, Item{item_id: 97, item_name: "randc.exe", flag: 0xee, value: 2}),
        (2359099, Item{item_id: 98, item_name: "capstar.exe", flag: 0xef, value: 2}),
        (2359100, Item{item_id: 99, item_name: "move.exe", flag: 0xf0, value: 2}),
        (2359101, Item{item_id: 100, item_name: "mekuri.exe", flag: 0xf1, value: 2}),
        (2359102, Item{item_id: 101, item_name: "bounce.exe", flag: 0xf2, value: 2}),
        (2359103, Item{item_id: 102, item_name: "miracle.exe", flag: 0xf3, value: 2}),
        (2359104, Item{item_id: 103, item_name: "mirai.exe", flag: 0xf4, value: 2}),
        (2359105, Item{item_id: 104, item_name: "lamulana.exe", flag: 0xf5, value: 2}),
        (2359106, Item{item_id: 70, item_name: "Map (Surface)", flag: 0xd1, value: 2}),
        (2359107, Item{item_id: 70, item_name: "Map (Gate of Guidance)", flag: 0xd2, value: 2}),
        (2359108, Item{item_id: 70, item_name: "Map (Mausoleum of the Giants)", flag: 0xd3, value: 2}),
        (2359109, Item{item_id: 70, item_name: "Map (Temple of the Sun)", flag: 0xd4, value: 2}),
        (2359110, Item{item_id: 70, item_name: "Map (Spring in the Sky)", flag: 0xd5, value: 2}),
        (2359111, Item{item_id: 70, item_name: "Map (Inferno Cavern)", flag: 0xd6, value: 2}),
        (2359112, Item{item_id: 70, item_name: "Map (Chamber of Extinction)", flag: 0xd7, value: 2}),
        (2359113, Item{item_id: 70, item_name: "Map (Twin Labyrinths)", flag: 0xd8, value: 2}),
        (2359114, Item{item_id: 70, item_name: "Map (Endless Corridor)", flag: 0xd9, value: 2}),
        (2359115, Item{item_id: 70, item_name: "Map (Shrine of the Mother)", flag: 0xda, value: 2}),
        (2359116, Item{item_id: 70, item_name: "Map (Gate of Illusion)", flag: 0xdb, value: 2}),
        (2359117, Item{item_id: 70, item_name: "Map (Graveyard of the Giants)", flag: 0xdc, value: 2}),
        (2359118, Item{item_id: 70, item_name: "Map (Temple of Moonlight)", flag: 0xdd, value: 2}),
        (2359119, Item{item_id: 70, item_name: "Map (Tower of the Goddess)", flag: 0xde, value: 2}),
        (2359120, Item{item_id: 70, item_name: "Map (Tower of Ruin)", flag: 0xdf, value: 2}),
        (2359121, Item{item_id: 70, item_name: "Map (Chamber of Birth)", flag: 0xe0, value: 2}),
        (2359122, Item{item_id: 70, item_name: "Map (Dimensional Corridor)", flag: 0xe1, value: 2}),
        (2359123, Item{item_id: 107, item_name: "Shuriken Ammo", flag: 0x85e, value: 1}),
        (2359124, Item{item_id: 108, item_name: "Rolling Shuriken Ammo", flag: 0x85e, value: 1}),
        (2359125, Item{item_id: 109, item_name: "Earth Spear Ammo", flag: 0x85e, value: 1}),
        (2359126, Item{item_id: 110, item_name: "Flare Gun Ammo", flag: 0x85e, value: 1}),
        (2359127, Item{item_id: 111, item_name: "Bomb Ammo", flag: 0x85e, value: 1}),
        (2359128, Item{item_id: 112, item_name: "Chakram Ammo", flag: 0x85e, value: 1}),
        (2359129, Item{item_id: 113, item_name: "Caltrops Ammo", flag: 0x85e, value: 1}),
        (2359130, Item{item_id: 114, item_name: "Pistol Ammo", flag: 0x85e, value: 1})
    ]);
}
